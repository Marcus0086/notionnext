...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
        <FaCode className="text-4xl text-yellow-600" />
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <FaCss3 className="text-4xl text-green-700" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
      ...
      <motion.div
        ...
        className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <PiPlugsConnected className="text-4xl text-blue-600" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Add your favioite integrations
        </p>
...
const items = [
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Use custom code for unlimited flexibility and integrations.
      </span>
    ),
    header: <SkeletonFour />,
