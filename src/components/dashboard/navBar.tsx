...
const NavBar = () => {
  ...
  return (
    <nav
      className="flex items-center flex-wrap justify-between w-full sticky top-0 md:top-4 z-40 p-2 rounded-xl
    ...
    >
      <div className="flex flex-col gap-y-4 items-start justify-center">
        ...
        <h3 className="text-cloudBurst dark:text-white text-2xl capitalize font-medium">
          {pathname.split("/")[1]}
        </h3>
      </div>
